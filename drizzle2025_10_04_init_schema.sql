...
CREATE TYPE "organ_condition"  AS ENUM ('healthy', 'unhealthy', 'unknown');
...
-- ================================
-- ORGANS  (matches production table: no "status")
-- ================================
CREATE TABLE "organs" (
  "id"                 uuid PRIMARY KEY DEFAULT gen_random_uuid(),
  ...
  "blood_type"         varchar NOT NULL,
  "condition"          "organ_condition" NOT NULL DEFAULT 'healthy',
  "viability_hours"    integer,
  "current_location"   varchar,
  "hla_markers"        jsonb,
  "special_requirements" varchar,
  "patient_mrn"        varchar,
  "patient_dob"        timestamptz,
  "patient_gender"     varchar,
  "hospital_name"      varchar,
  "created_at"         timestamptz NOT NULL DEFAULT now()
);
-- removed: idx_organs_status (column doesn't exist)
